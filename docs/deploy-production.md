...
| `CORS_EXTRA_ORIGINS` | Mobile/prod app | Extra allowed origins beyond `FRONTEND_URL`. | Comma-separated exact app origins: `http://localhost,capacitor://localhost,https://girospesa.localhost,https://app.girospesa.local,capacitor://app.girospesa.local`. Never use wildcards. |
